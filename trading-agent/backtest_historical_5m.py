"""
backtest_historical_5m.py — ETH+SOL 3 régimes en VRAIS 5min
=============================================================
Source : Binance US API (api.binance.us) — pas géo-bloqué depuis Replit
Symbols : ETHUSD + SOLUSD

Régimes testés (2 mois de test + 3 mois warmup zones) :
  2022 Bearish : Mai–Juin 2022   (crash Terra/LUNA, ETH -70%)
  2023 Regain  : Jan–Fév 2023   (rebond post-FTX, ETH +60%)
  2024 Bullish : Mar–Avr 2024   (bull run BTC ATH, ETH +40%)

Configs : A — ETH-only | B — SOL-only | C — ETH+SOL pool partagé
...
def main():
    print("\n" + "═"*78)
    print("  Geo V4 — VRAIS 5min — 3 régimes historiques (Binance US)")
    print("  ETH-only / SOL-only / ETH+SOL pool | $1000 | 50% pos | zone±0.3% | target+0.9%")
    print("  Warmup 90j → mêmes paramètres qu'en production")
    print("═"*78)
