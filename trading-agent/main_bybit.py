"""
main_bybit.py — Jim Bot Geo-Only ETH+SOL [BYBIT MODE]
Boucle : fast loop 30s + slow loop 5min + watchdog.
Broker : BybitBroker (broker_bybit.py) — demo ou live via BYBIT_DEMO.
"""
import logging
import os
import threading
...
def main():
    logger.info("🚀 Trading Agent starting... [BYBIT MODE]")
